package ilyas.xo.view;

import ilyas.xo.controllers.CurrentMoveController;
import ilyas.xo.controllers.MoveController;
import ilyas.xo.controllers.WinnerController;
...
public class ConsoleView {
    ...
    public boolean move(final Game game) {
        ...
        try {
            moveController.apllyFigure(field, currentFigure, point);
    ...
    private int askCoordinate(final String coordinateName) {
        ...
        try {
            ...
            System.out.println("0_0 ololololo!!!!");
